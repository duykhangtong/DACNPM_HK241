...
function Report() {
  ...
  useEffect(() => {
    const fetchStatisticsData = async () => {
      try {
        const response = await axios.get("http://localhost:80/api/statistics", {
                ...
                {[
                  {
                    ...
                    month: 10,
                    year: 2024,
                    detail: "Báo cáo tháng 10/2024",
                  },
                  {
                    id: 2,
                    month: 9,
                    year: 2024,
                    detail: "Báo cáo tháng 9/2024",
                  },
                  {
                    id: 3,
                    month: 8,
                    year: 2024,
                    detail: "Báo cáo tháng 8/2024",
                  },
                  {
                    id: 4,
                    month: 7,
                    year: 2024,
                    detail: "Báo cáo tháng 7/2024",
                  },
                  {
                    id: 5,
                    month: 6,
                    year: 2024,
                    detail: "Báo cáo tháng 6/2024",
                  },
                  {
                    id: 6,
                    month: 5,
                    year: 2024,
                    detail: "Báo cáo tháng 5/2024",
                  },
                  {
                    id: 7,
                    month: 4,
                    year: 2024,
                    detail: "Báo cáo tháng 4/2024",
                  },
                  {
                    id: 8,
                    month: 3,
                    year: 2024,
                    detail: "Báo cáo tháng 3/2024",
                  },
                  {
                    id: 9,
                    month: 2,
                    year: 2024,
                    detail: "Báo cáo tháng 2/2024",
                  },
                ].map((item) => (
                  <tr key={item.id}>
                    <td>{item.id}</td>
        ...
        <div className="statistics-container">
          ...
          <table className="statistics-table">
            ...
            <thead>
              ...
              <tr>
                {" "}
                <th>STT</th> <th>Máy in</th> <th>Số đơn đặt hàng</th>{" "}
                <th>Số trang giấy A3</th> <th>Số trang giấy A4</th>{" "}
              </tr>{" "}
            </thead>{" "}
            <tbody>
              {" "}
              {statisticsData.length === 0 ? (
                ...
                statisticsData.map((data, index) => (
                  <tr key={data.id}>
                    {" "}
                    <td>{index + 1}</td> <td>{data.printerName}</td>{" "}
                    <td>{data.orderCount}</td> <td>{data.a3Pages}</td>{" "}
                    <td>{data.a4Pages}</td>{" "}
                  </tr>
                ))
              )}{" "}
